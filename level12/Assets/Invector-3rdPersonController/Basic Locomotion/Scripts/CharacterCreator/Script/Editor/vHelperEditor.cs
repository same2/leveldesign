...
{    
    ...
    {        
	    ...
	    GUILayout.Label("Basic Locomotion Version: 2.2.2", EditorStyles.boldLabel);
        GUILayout.FlexibleSpace();
        ...
        GUILayout.BeginHorizontal("box");
        GUILayout.FlexibleSpace();
	    GUILayout.Label("Melee Combat Version: 2.2.2", EditorStyles.boldLabel);
        GUILayout.FlexibleSpace();
        ...
        GUILayout.BeginHorizontal("box");
        GUILayout.FlexibleSpace();
        GUILayout.Label("Shooter Version: 1.1.2", EditorStyles.boldLabel);
        GUILayout.FlexibleSpace();
        if (GUILayout.Button("Check for Update"))
        {
